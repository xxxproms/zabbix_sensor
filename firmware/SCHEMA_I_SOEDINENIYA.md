...
| Модуль ENC28J60 | Arduino Uno / Nano | Назначение |
|-----------------|-------------------|------------|
| VCC (3.3 В) | **3.3V** | Питание |
| GND | **GND** | Земля |
| CS | **D10** | SPI Chip Select |
| SO | **D12** (MISO) | SPI Data Out |
| SI | **D11** (MOSI) | SPI Data In |
| SCK | **D13** | SPI Clock |
| **RST** | **D3** | **Аппаратный сброс (обязательно!)** |

**RST → D3** — критически важен для стабильной работы 24/7. Без этого провода прошивка не может сбросить зависший ENC28J60, и помогает только полное обесточивание. Подключите проводом пин RST (RESET) на модуле ENC28J60 к пину D3 на Arduino.
