...
2. При необходимости — **статический IP**: раскомментируйте `#define USE_STATIC_IP 1` и задайте `ip`, `gateway`, `subnet`, `dnsServer`.
...
Репозиторий нужно создать **в вашем аккаунте** GitHub (веб-интерфейс или GitHub CLI), затем привязать remote и отправить ветку:
